...
export default {
  ...
  computed: {
    ...
    label () {
      console.log('@TODO Submit select label() change')
      if (this.value == null) {
        return this.placeholder
      }
      return this.multiple ? this.__getMultipleLabel() : this.__getSingleLabel()
  ...
  watch: {
    options: {
      deep: true,
      handler (options) {
        console.log('@TODO Fix select handler properly')
